...
const UniversityDetails: React.FC<UniversityDetailsProps> = ({ universities }) => {
  ...
  const galleryImages = [
    getOptimizedImageUrl(uni.image, 1600),
    getOptimizedImageUrl('https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=1200&q=80', 1600),
    getOptimizedImageUrl('https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=1200&q=80', 1600),
    getOptimizedImageUrl('https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=1200&q=80', 1600),
  ];
